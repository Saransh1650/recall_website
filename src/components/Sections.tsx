import { Zap, Target, User, Calendar, Star, CheckCircle2 } from "lucide-react";
      ...
      <div className={styles.grid}>
        <div className={styles.text}>
          ...
          <p className={styles.p}>
            Start recording and stay present in the conversation. RECALL
            captures everything in the background — so you never have to choose
            between listening and remembering.
          </p>
          <ul className={styles.checks}>
            <li>
              <CheckIcon /> Works in any environment
            </li>
            <li>
              <CheckIcon /> Real-time speaker detection
            </li>
            <li>
              <CheckIcon /> Runs fully in the background
            </li>
          </ul>
        </div>
        <div className={styles.visual}>
          <div className={styles.recCard}>
            ...
            <div className={styles.bigWave}>
              {[
                30, 55, 80, 60, 90, 45, 70, 95, 50, 75, 40, 65, 85, 35, 60, 80,
                45,
              ].map((h, i) => (
                <span
                  key={i}
          ...
          <div className={styles.aiCard}>
            ...
            <div className={styles.bubbles}>
              ...
              <div className={`${styles.tbubble} ${styles.tbubbleYou}`}>
                <Image
                  ...
                  width={24}
                  height={24}
                  className={`${styles.tname} ${styles.tnameYou}`}
                />
            ...
            <div className={styles.transformRow}>
              ...
              <span className={styles.tLabel}>
                <Zap size={14} style={{ marginRight: "6px", flexShrink: 0 }} />
                AI understanding
              </span>
              <div className={styles.tLine} />
            </div>
    ...
    <section className={styles.section}>
      <div className={styles.centered}>
        ...
        <h2 className={styles.h2Center}>
          Every conversation becomes a<br />
          clean, structured journal entry.
        </h2>
          ...
          <div className={styles.jfBody}>
            <div className={styles.jfHeader}>
              ...
              <Image
                ...
                width={40}
                height={40}
                className={styles.jfAvatar}
              />
            </div>
            <div className={styles.jfDivider} />
            <p className={styles.jfLine}>
              Alex will own the launch timeline. Prefers to communicate async
              over Slack, not email.
            </p>
            <p className={styles.jfLine}>
              Agreed to send a draft by Wednesday. Follow up Thursday to
              confirm.
            </p>
            <p className={styles.jfLine}>
              Alex seems methodical and thorough — reliable on delivery
              promises.
            </p>
            <div className={styles.jfTagRow}>
              <span className={`${styles.jfTag} ${styles.tagOrange}`}>
                <Calendar size={12} style={{ flexShrink: 0 }} />
                Follow up Thu
              </span>
              <span className={`${styles.jfTag} ${styles.tagPurple}`}>
                <Star size={12} style={{ flexShrink: 0 }} />
                Reliable
              </span>
              <span className={`${styles.jfTag} ${styles.tagGreen}`}>
                <CheckCircle2 size={12} style={{ flexShrink: 0 }} />
                Action item
              </span>
              <span className={`${styles.jfTag} ${styles.tagBlue}`}>
...
export function SectionPeople() {
  const people = [
    { name: "Alex Chen", role: "Work · Colleague", image: "/alex.png" },
    { name: "Dr. Kumar", role: "Health · Doctor", image: "/doctor.png" },
    { name: "Rachel", role: "Personal · Friend", image: "/girl.png" },
    { name: "David", role: "Career · Mentor", image: "/boy.png" },
  ];
    ...
    <section className={`${styles.section} ${styles.sectionAlt}`}>
      <div className={styles.grid}>
        ...
        <div className={styles.text}>
          ...
          <h2 className={styles.h2}>
            RECALL learns voices and
            <br />
            organizes memories around the people in your life.
          </h2>
          <p className={styles.p}>
            Over time, RECALL builds a rich picture of your relationships — who
            said what, when, and how they follow through.
          </p>
          <ul className={styles.checks}>
            <li>
              <CheckIcon /> Automatic speaker identification
            </li>
            <li>
              <CheckIcon /> Conversation history per person
            </li>
            <li>
              <CheckIcon /> Pattern detection over time
            </li>
          </ul>
        </div>
      </div>
        ...
        <div className={styles.searchCard}>
          <div className={styles.searchBar}>
            ...
            <span className={styles.searchQuery}>
              What did Alex say about the launch timeline?
            </span>
          ...
          <div className={styles.searchResults}>
            <div className={styles.resultMeta}>
              1 result · Conversation with Alex · Today
            </div>
              ...
              <div className={styles.resultBody}>
                <p className={styles.resultText}>
                  ...
                  <mark className={styles.highlight}>
                    I&apos;ll handle the launch timeline
                  </mark>{" "}
                  — I&apos;ll send the draft by Wednesday.&rdquo;
                </p>
                <span className={styles.resultSpeaker}>
                  Alex Chen · 10:42 AM
                </span>
              </div>
            </div>
